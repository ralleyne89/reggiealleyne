...
const BentoCard = ({
  ...
  <div
    ...
    className={cn(
      ...
      "transition-all duration-300 hover:border-[rgba(145,108,231,0.3)] hover:shadow-[0_0_15px_rgba(145,108,231,0.15)]",
      className,
    )}
  >
    ...
    <div className="pointer-events-none z-10 flex transform-gpu flex-col gap-1 p-6 transition-all duration-300 group-hover:-translate-y-10">
      ...
      <p className="max-w-lg text-[rgba(153,153,153,1)]">{description}</p>
    </div>
    ...
    >
      <Button variant="ghost" asChild size="sm" className="pointer-events-auto text-primary hover:bg-primary/10">
        <a href={href}>
          {cta}

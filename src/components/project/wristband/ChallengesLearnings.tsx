      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {wristbandChallengesData.challenges.map((challenge, index) => <div key={index} className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {wristbandChallengesData.learnings.map((learning, index) => <div key={index} className="bg-green-50 rounded-xl p-6 border border-green-200">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {wristbandChallengesData.nextSteps.map((step, index) => {

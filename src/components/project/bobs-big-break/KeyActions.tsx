      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            Four critical initiatives that transformed the initial concept into a fully functional game prototype within our 2-week timeline.
          </p>
        </motion.div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="bg-primary/5 rounded-lg p-3">
                      <span className="text-sm font-medium text-primary uppercase tracking-wide">Impact</span>
                      <p className="text-sm text-gray-800 mt-1">{action.impact}</p>
                    </div>
                  </div>
                </div>
              </motion.div>

        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-xl p-8">
              <div className="flex flex-col items-center space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
                  {secondaryItems.map((item, index) => <motion.div key={index} className="bg-white border border-gray-200 text-gray-900 px-4 py-3 rounded-xl font-medium text-center hover:border-primary/30 hover:bg-gray-50 transition-colors duration-300" initial={{
                  opacity: 0,
                  y: 20
                }} whileInView={{
                  opacity: 1,
          ...
          amount: 0.3
            ...
            <div className="space-y-8">
              {wireframeImages.map((image, index) => <motion.div key={index} className="space-y-4" initial={{
              opacity: 0,
              y: 20
            }} whileInView={{
              opacity: 1,
              ...
              amount: 0.3
                  ...
                  <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 hover:border-primary/30 transition-colors duration-300">
                    <img src={image.imageSrc} alt={image.imageAlt} className="w-full rounded-lg" />
                  </div>
                </motion.div>)}
            </div>
          </motion.div>

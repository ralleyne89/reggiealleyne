        ...
        <div className="mb-12">
          ...
          <div className="bg-gray-50 rounded-xl p-8 mb-12">
            ...
            <p className="text-lg text-gray-700 leading-relaxed mb-8">
              Tech Noir successfully bridged the gap between wearable technology and fashion, 
              creating a unique e-commerce model that educates users while inspiring confident 
              exploration of tech-fashion integration.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white border border-gray-200 rounded-lg p-6 text-center">
                ...
                <h4 className="text-gray-900 font-medium mb-2">User Confidence</h4>
                <p className="text-gray-600 text-sm">of testers felt more confident exploring wearable tech after using the app</p>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 text-center">
                ...
                <h4 className="text-gray-900 font-medium mb-2">Positive Feedback</h4>
                <p className="text-gray-600 text-sm">on luxury aesthetic and video styling modules from user testing</p>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 text-center">
                ...
                <div className="text-3xl font-bold text-primary mb-2">Enhanced</div>
                <h4 className="text-gray-900 font-medium mb-2">User Experience</h4>
                <p className="text-gray-600 text-sm">Research-informed personas led to better content structure and usability</p>
              </div>
            </div>
          </div>

...
const tools: ToolItem[] = [
  {
    name: "Figma",
    role: "I map flows, pressure-test states, and get the product shape clear before build.",
    proof: "Used before code when the decision needs to be visible.",
    tone: "figma",
  },
  {
    name: "React",
    role: "I turn interface decisions into working screens people can click, test, and critique.",
    proof: "Used when fidelity needs real behavior.",
    tone: "react",
  },
  {
    name: "Supabase",
    role: "I use it to give prototypes real accounts, data, storage, and submission paths.",
    proof: "Used when the UI needs real product constraints.",
    tone: "supabase",
  },
  {
    name: "VS Code",
    role: "I live here while building, debugging, reviewing diffs, and tightening the last details.",
    proof: "Used for day-to-day implementation.",
    tone: "vscode",
  },
  {
    name: "Codex",
    role: "I use it to inspect repos, catch weak spots, and move faster through focused implementation passes.",
    proof: "Used for audits, fixes, and refactors.",
    tone: "codex",
  },
  {
    name: "Tailwind CSS",
    role: "I keep spacing, responsive behavior, and visual polish close to the component code.",
    proof: "Used when speed and consistency both matter.",
    tone: "tailwind",
  },
  {
    name: "Adobe Suites",
    role: "I clean up assets, prep visuals, and handle the design details that need extra finish.",
    proof: "Used for polish, mockups, and handoff assets.",
    tone: "adobe",
  },
  {
    name: "Framer Motion",
    role: "I add motion when it clarifies hierarchy, pacing, or feedback instead of decorating the page.",
    proof: "Used for purposeful interaction polish.",
    tone: "framer",
  },
  {
    name: "GitHub",
    role: "I use it to keep changes reviewable, traceable, and ready to ship without mystery.",

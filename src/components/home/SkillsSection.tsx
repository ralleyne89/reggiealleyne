...
import { Zap, Brain, Workflow, Sparkles, Code, Palette, Layout, Smartphone, Users, Shield, Search, Repeat, Heart, BookOpen } from "lucide-react";
          ...
          <motion.div initial={{
            ...
            <div className="grid grid-cols-1 gap-4">
              {expertiseSkills.map((skill, index) => (
                <motion.div key={index} className="bg-secondary p-4 rounded-xl border border-gray-800 hover:border-primary/20 transition-colors" initial={{
                  opacity: 0,
                  y: 20
                }} whileInView={{
                  opacity: 1,

...
const SocialCard = () => {
  return (
    <div className="bg-[rgba(16,16,16,1)] border min-h-[343px] grow overflow-hidden w-full px-5 py-[19px] border-[rgba(255,255,255,0.05)] border-solid transition-all duration-300 hover:bg-[rgba(20,20,20,1)] hover:border-[rgba(145,108,231,0.3)] hover:shadow-[0_0_15px_rgba(145,108,231,0.15)] hover:-translate-y-1">

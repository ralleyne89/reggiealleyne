    ...
    <>
      <div className="bg-[rgba(16,16,16,1)] border relative flex w-full flex-col overflow-hidden items-stretch pl-3.5 pr-[13px] pt-5 pb-[30px] rounded-xl border-[rgba(255,255,255,0.05)] border-solid transition-all duration-300 hover:bg-[rgba(20,20,20,1)] hover:border-[rgba(145,108,231,0.3)] hover:shadow-[0_0_15px_rgba(145,108,231,0.15)] hover:-translate-y-1">
        ...
        <button 
          ...
          className="bg-[rgba(145,108,231,1)] absolute gap-2.5 text-sm text-white font-medium -translate-x-2/4 translate-y-[0%] px-[30px] py-[13px] rounded-xl border-[rgba(16,16,16,1)] border-solid border-2 left-2/4 bottom-3.5 transition-all duration-300 hover:scale-105 hover:shadow-lg active:scale-95 active:shadow-inner max-md:px-5"
        >
          View All Services
        </button>
      </div>
      <ServicesDialog open={dialogOpen} onOpenChange={setDialogOpen} />
    </>
  );
};

...
const TechStack = () => {
  ...
  return (
    <div className="bg-[rgba(16,16,16,1)] border p-4 sm:p-5 border-[rgba(255,255,255,0.05)] border-solid transition-all duration-300 hover:bg-[rgba(20,20,20,1)] hover:border-[rgba(145,108,231,0.3)] hover:shadow-[0_0_15px_rgba(145,108,231,0.15)] hover:-translate-y-1">
      ...
      <div className="w-full mt-[30px] space-y-2">
        <div className="grid grid-cols-2 gap-2">
          {tools.map((tool, index) => (
            <div 
              key={index} 
              className="bg-[rgba(25,25,25,1)] flex items-center px-3 py-2 transition-all duration-300 hover:bg-[rgba(30,30,30,1)] hover:shadow-[0_0_10px_rgba(145,108,231,0.1)] animate-fade-in"

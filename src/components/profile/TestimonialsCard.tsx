...
const TestimonialsCard = () => {
  return (
    <div className="bg-[rgba(16,16,16,1)] border flex min-h-[369px] grow flex-col overflow-hidden items-center w-full pt-2.5 border-[rgba(255,255,255,0.06)] border-solid transition-all duration-300 hover:bg-[rgba(20,20,20,1)] hover:border-[rgba(145,108,231,0.3)] hover:shadow-[0_0_15px_rgba(145,108,231,0.15)] hover:-translate-y-1">
      ...
      <div className="max-w-full w-[342px] overflow-hidden font-medium">
        ...
        />
        <div className="bg-[rgba(20,20,20,1)] border mt-[-65px] w-[291px] max-w-full ml-3 p-3 rounded-[15px] border-[rgba(255,255,255,0.06)] border-solid max-md:ml-2.5">
        ...
        <div className="flex shrink-0 h-[97px] mt-2.5" />
      </div>
    </div>
  );
};

...
const ProjectsCard = () => {
  return (
    <div className="bg-[rgba(16,16,16,1)] border relative flex min-h-[226px] w-full flex-col overflow-hidden pt-5 pb-[151px] px-5 rounded-[20px] border-[rgba(255,255,255,0.05)] border-solid max-md:pb-[100px]">

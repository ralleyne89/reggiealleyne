...
const ProjectsCard = () => {
  return (
    <div className="bg-[rgba(16,16,16,1)] border relative flex min-h-[226px] w-full flex-col overflow-hidden pt-5 pb-[151px] px-5 rounded-xl border-[rgba(255,255,255,0.05)] border-solid transition-all duration-300 hover:bg-[rgba(20,20,20,1)] hover:border-[rgba(145,108,231,0.3)] hover:shadow-[0_0_15px_rgba(145,108,231,0.15)] hover:-translate-y-1">
      <div className="self-stretch z-0 flex w-full flex-col items-center mb-6">
      ...
      <Link 
        to="/works"
        className="absolute left-1/2 -translate-x-1/2 bottom-6 bg-[rgba(145,108,231,1)] gap-2.5 text-sm text-white font-medium px-8 py-3 rounded-xl border-[rgba(16,16,16,1)] border-solid border-2 transition-all duration-300 hover:scale-105 hover:shadow-lg active:scale-95 active:shadow-inner"
      >
        View Works
      </Link>
    </div>

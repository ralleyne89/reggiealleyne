...
const StatsCard = () => {
  const stats = [
    { label: 'Projects', icon: <Trophy className="w-5 h-5 text-[#916CE7]" /> },
    { label: 'Happy Clients', icon: <Users className="w-5 h-5 text-[#916CE7]" /> },
    { label: 'Year Expertise', icon: <Clock className="w-5 h-5 text-[#916CE7]" /> }
  ];

    ...
    <div className="bg-[rgba(16,16,16,1)] border w-full max-w-[463px] p-5 rounded-[20px] border-[rgba(255,255,255,0.06)] border-solid">
      <div className="flex w-full gap-[15px] max-md:max-w-full">
        <img
          ...
          className="aspect-[1] object-contain w-[101px] shrink-0 rounded-[0px_0px_0px_0px]"
          alt="Profile"
        />
        <div className="flex min-w-60 flex-col items-stretch flex-1 shrink basis-[0%]">
          <div className="flex w-full items-center gap-[40px_52px] font-medium justify-between">
      ...
      <div className="bg-[rgba(20,20,20,1)] border flex w-full gap-2.5 text-[13px] text-[rgba(204,204,204,1)] font-medium flex-wrap mt-[30px] p-3 rounded-[10px] border-[rgba(255,255,255,0.06)] border-solid">
      ...
      <div className="flex w-full gap-3 text-[13px] text-[rgba(204,204,204,1)] font-medium mt-[30px]">
        <button className="bg-[rgba(31,31,31,1)] flex items-center gap-2.5 justify-center flex-1 shrink basis-[0%] px-2.5 py-4 rounded-[10px]">
          <img
            loading="lazy"
        ...
        <button className="bg-[rgba(31,31,31,1)] gap-2.5 flex-1 shrink px-2.5 py-4 rounded-[10px]">
          WhatsApp Me
        </button>
      </div>
    </div>

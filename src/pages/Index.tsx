...
import { ArrowRight, Code, Palette, Mail, BookOpen, Target, Users, Pen, Layout, Smartphone, Zap, Search, Repeat, Heart, Shield, Sparkles, Brain, Workflow, Lightbulb, Gamepad2, Coffee } from "lucide-react";
...
const Index = () => {
  ...
  const uniqueExperiences = [{
    ...
    description: "Bridging the gap between design vision and technical reality"
  }, {
  ...
  const aboutMeValues = [{
    ...
    description: "I'm fascinated by AI's potential to solve real problems—not just generate more content. I want to design interfaces that make AI feel helpful, not overwhelming."
  }, {
    icon: <Users className="w-6 h-6 text-primary" />,
    title: "Leading Through Collaboration",
    description: "I believe the best ideas come from diverse perspectives. I'm the designer who asks developers 'what if we tried this?' and actually listens to the answer."
  }, {
    icon: <Target className="w-6 h-6 text-primary" />,
    title: "Solving Problems, Not Just Making Mockups",
    description: "I dig deep into user research, prototype rapidly, and iterate based on real feedback. Pretty designs are great, but usable ones change lives."
  }];
  const interests = [{
  ...
  return <>
      <motion.div ref={targetRef} className="h-screen max-h-screen w-full pt-28 relative overflow-hidden bg-white flex flex-col justify-center">
        ...
        y
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <motion.div className="text-center lg:text-left" initial="hidden" animate="visible" variants={staggerContainer}>
              ...
              <motion.p variants={fadeInUp} className="text-text-secondary text-lg md:text-xl mb-8 max-w-xl mx-auto lg:mx-0 mt-6">
              ...
              <motion.div variants={fadeInUp} className="flex flex-wrap gap-4 justify-center lg:justify-start">
                <motion.a href="#projects" className="bg-gradient-to-r from-primary to-primary-dark text-white px-6 py-3 rounded-full font-medium inline-flex items-center gap-2 shadow-lg shadow-primary/20" variants={buttonVariants} whileHover="hover" whileTap="tap">
                  View My Work
                  <ArrowRight size={18} />
                </motion.a>

                <motion.a href="#contact" className="bg-transparent border border-gray-300 text-text-primary px-6 py-3 rounded-full font-medium inline-flex items-center gap-2 hover:border-primary transition-colors duration-300" variants={buttonVariants} whileHover="hover" whileTap="tap">
                  Contact Me
                </motion.a>
              </motion.div>
            </motion.div>

            <motion.div className="relative mx-auto max-w-sm lg:max-w-full" initial={{
            opacity: 0,
            scale: 0.8
          }} animate={{
            opacity: 1,
            ...
            delay: 0.2
              ...
              <div className="relative">
                ...
                <div className="relative rounded-3xl overflow-hidden w-full h-[400px] border border-gray-200 shadow-2xl">
                  ...
                  <motion.div className="absolute top-4 right-4 bg-black/40 backdrop-blur-md rounded-full px-3 py-2 border border-white/20" initial={{
                  opacity: 0,
                  y: -20
                }} animate={{
                  opacity: 1,
                  ...
                  {/* Location Badge */}
                  <motion.div className="absolute bottom-4 left-4 bg-black/40 backdrop-blur-md rounded-full px-3 py-2 border border-white/20" initial={{
                  opacity: 0,
                  y: 20
                }} animate={{
                  opacity: 1,
                  ...
                  <motion.div className="absolute inset-0 bg-primary/10 opacity-0 transition-opacity duration-300 hover:opacity-100 flex items-center justify-center" whileHover={{
                  opacity: 1
                }}>
                    <motion.div className="text-white text-center" initial={{
                    scale: 0.8,
                    opacity: 0
                  }} whileHover={{
                    scale: 1,
                ...
                <motion.div className="absolute -top-6 -right-6 w-20 h-20 bg-primary/20 rounded-full blur-xl" animate={{
                scale: [1, 1.2, 1],
                opacity: [0.4, 0.6, 0.4],
                rotate: [0, 180, 360]
              }} transition={{
                ...
                <motion.div className="absolute -bottom-4 -left-4 w-16 h-16 bg-secondary/30 rounded-full blur-lg" animate={{
                scale: [1, 1.3, 1],
                opacity: [0.3, 0.5, 0.3],
                x: [0, 10, 0]
              }} transition={{
                ...
                {/* Geometric Accent */}
                <motion.div className="absolute top-1/2 -left-8 w-3 h-3 bg-primary rounded-full" animate={{
                y: [-10, 10, -10],
                opacity: [0.5, 1, 0.5]
              }} transition={{
                duration: 3,
        ...
        repeat: Infinity
          ...
          <div className="w-6 h-10 rounded-full border-2 border-text-secondary flex justify-center pt-1">
            <motion.div className="w-1.5 h-1.5 rounded-full bg-primary" animate={{
            y: [0, 12, 0]
          }} transition={{
            duration: 1.5,
            repeat: Infinity
      ...
      <section id="projects" className="py-12 bg-secondary relative">
        <div className="container mx-auto px-4">
          ...
          {isLoading ? <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 animate-pulse">
            ...
            return featuredProjects.map((project, index) => <ProjectCard key={project.id} title={project.title} description={project.description} image={project.image} slug={project.slug || project.id.toString()} tags={project.tags} featured={false} index={index} />);
          })()}
            </div>}
      ...
      <section id="skills" className="py-20 bg-secondary-dark relative">
        <div className="container mx-auto px-4">
          <div className="max-w-xl mx-auto text-center mb-16">
            ...
            <motion.p className="text-text-muted" initial={{
            opacity: 0,
            y: 30
          }} whileInView={{
            opacity: 1,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            amount: 0.3
              ...
              <div className="grid grid-cols-1 gap-4">
                {expertiseSkills.map((skill, index) => <motion.div key={index} className="bg-secondary p-4 rounded-xl border border-gray-800 hover:border-primary/20 transition-colors" initial={{
                opacity: 0,
                y: 20
              }} whileInView={{
                opacity: 1,
            ...
            amount: 0.3
              ...
              <div className="grid grid-cols-1 gap-4">
                {methodologySkills.map((skill, index) => <motion.div key={index} className="bg-secondary p-4 rounded-xl border border-gray-800 hover:border-primary/20 transition-colors" initial={{
                opacity: 0,
                y: 20
              }} whileInView={{
                opacity: 1,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-12">
            ...
            amount: 0.3
              ...
              <div className="grid grid-cols-1 gap-4">
                {processSteps.map((step, index) => <motion.div key={index} className="bg-secondary p-4 rounded-xl border border-gray-800 hover:border-primary/20 transition-colors" initial={{
                opacity: 0,
                y: 20
              }} whileInView={{
                opacity: 1,
            ...
            amount: 0.3
              ...
              <div className="grid grid-cols-1 gap-4">
                {uniqueExperiences.map((experience, index) => <motion.div key={index} className="bg-secondary p-4 rounded-xl border border-gray-800 hover:border-primary/20 transition-colors" initial={{
                opacity: 0,
                y: 20
              }} whileInView={{
                opacity: 1,
      ...
      <section id="about" className="py-20 bg-secondary relative">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            {/* About Content */}
            <motion.div className="space-y-8 mb-16" initial={{
            opacity: 0,
            y: 30
          }} whileInView={{
            opacity: 1,
            ...
            <motion.div className="bg-secondary-dark rounded-xl p-8 border border-gray-700" initial={{
            opacity: 0,
            y: 30
          }} whileInView={{
            opacity: 1,
            ...
            amount: 0.3
              ...
              <div className="text-center mt-8">
                <motion.a href="#contact" className="inline-flex items-center px-8 py-3 bg-primary text-white font-semibold rounded-lg hover:bg-primary-dark transition-colors" whileHover={{
                scale: 1.05
              }} whileTap={{
                scale: 0.95
              }}>
      ...
      <section id="education" className="py-20 bg-secondary-dark relative">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {education.map((item, index) => <motion.div key={index} className="bg-secondary rounded-3xl p-6 relative overflow-hidden group" initial={{
            opacity: 0,
            y: 50
          }} whileInView={{
            opacity: 1,

...
export const scentStackOverviewData: ProjectOverviewProps = {
  ...
  description: [
    ...
    "Technical architecture: React + Tailwind CSS frontend with editorial design system, GPT-4 integration for natural language scent matching, computer vision pipeline for photo-based fragrance analysis, comprehensive database of 1732+ dupes across 148+ designer brands."
  ],
  projectDetails: [
    {
      label: "Outcome",
...
export const scentStackProblemSpaceData: ProblemSpaceProps = {
  ...
  introduction: "Luxury fragrances command premium prices—often $200-400 for a bottle—despite the fact that nearly identical scent profiles exist at a fraction of the cost. Meanwhile, fragrance layering (combining scents for unique profiles) remains an insider art with no accessible guidance, and the gap between imagining your perfect scent and actually finding it has no bridge.",
  challenges: [
    {
      title: "The Luxury Fragrance Tax",
      description: "Identical scent formulas cost 10x more based solely on brand prestige. Consumers lack visibility into affordable alternatives that smell nearly identical.",
      icon: DollarSign
    },
    {
      title: "Layering Complexity",
      description: "Fragrance enthusiasts know that layering creates unique signature scents, but beginners have no guidance on which fragrances complement each other.",
      icon: Layers
    },
    {
      title: "The Dream Scent Gap",
      description: "People can describe their ideal scent in words—'warm vanilla with smoky undertones'—but have no way to translate that vision into actual product recommendations.",
      icon: Lightbulb
    }
  ],
  designGoals: [
    {
      ...
      description: "Show luxury originals alongside affordable dupes with clear savings percentages, democratizing access to premium scent experiences.",
      icon: Search
    },
    {
      title: "AI-Powered Accessibility",
      description: "Use GPT-4 and computer vision to make fragrance expertise accessible—from layering suggestions to dream scent matching.",
      icon: Brain
    },
    {
      title: "Collector's Resource",
      description: "Create the comprehensive fragrance database I wished existed as a collector—organized, searchable, and constantly updated.",
      icon: Heart
    }
  ]
};
...
export const scentStackResearchData: ResearchDiscoveryProps = {
  ...
  introduction: "As an active fragrance collector and community member, I had direct access to user pain points. I analyzed existing platforms (Fragrantica, Parfumo), fragrance subreddits, and collector communities to understand what was missing. The pattern was clear: information was scattered, price comparisons were manual, and AI potential was untapped.",
  researchSections: [
    {
  ...
  keyFindings: [
    {
      ...
      description: "Dupe information exists but is scattered across forums, requiring manual research. A centralized, searchable database would save hours of effort."
    },
    {
      title: "Finding #2: AI Opportunity",
      description: "GPT-4's natural language capabilities could bridge the gap between scent descriptions and product recommendations—a feature no competitor offers."
    },
    {
      title: "Finding #3: Visual Learning",
      description: "Fragrance enthusiasts often photograph their collections. Computer vision could analyze these photos to suggest layering combinations."
    }
  ]
};
...
export const scentStackIdeationData: IdeationStrategyProps = {
  ...
  introduction: "With 3 weeks and a clear personal vision, I focused on three core features that would differentiate ScentStack while remaining achievable as a solo developer. Each pillar addresses a specific user pain point I'd experienced firsthand.",
  keyInsights: [
    {
      highlight: "Discover: Democratize luxury scents.",
      description: "A comprehensive dupe database with transparent price comparisons, showing users exactly how much they can save with affordable alternatives."
    },
    {
      highlight: "Dream Lab: Translate imagination to reality.",
      description: "GPT-4 integration that interprets natural language scent descriptions and recommends specific fragrances or combinations."
    },
    {
      highlight: "Layering Lab: Make expertise accessible.",
      description: "Computer vision that analyzes photos of existing fragrances and suggests complementary scents for unique layered profiles."
    }
  ],
  flowSteps: [
    {
...
export const scentStackUIData: FinalUIDesignProps = {
  introduction: "The visual design needed to feel premium enough to discuss luxury fragrances while remaining accessible and approachable. I chose an editorial aesthetic with purple accents and Bento-style card layouts that organize complex information elegantly.",
  designHighlights: [
    {
  ...
  uiFeatures: [
    ...
    },
    {
      ...
      description: "Natural language input field with conversational AI that interprets scent descriptions and returns personalized recommendations.",
      icon: Sparkles
    },
    {
      title: "Layering Lab Upload",
      description: "Photo upload flow with computer vision analysis, returning complementary fragrance suggestions with layering guidance.",
      icon: Camera
    }
  ],
  uiImages: [
  ...
  challenges: [
    {
      ...
      description: "Building a database of 1732+ dupes required systematic data collection and validation. Solution: Leveraged fragrance community resources and created structured data entry workflows to maintain quality while moving fast."
    },
    {
      title: "AI Integration Complexity",
      description: "GPT-4's scent matching required careful prompt engineering to translate subjective descriptions into concrete recommendations. Solution: Developed specialized prompts that capture note profiles, longevity preferences, and occasion contexts."
    },
    {
      title: "Photo Analysis Accuracy",
      description: "Computer vision needed to identify fragrance bottles from various angles and lighting conditions. Solution: Focused on major brands first, building a recognition pipeline that could be expanded over time."
    }
  ],
  learnings: [
    {
      title: "Domain Expertise Accelerates Development",
      description: "Being a fragrance collector meant I understood user needs intuitively. Personal passion projects benefit from deep domain knowledge that would take months to acquire otherwise."
    },
    {
      title: "AI as Feature Multiplier",
      description: "GPT-4 and computer vision transformed what would have been a static database into an intelligent discovery platform. AI features differentiate and delight."
    },
    {
      title: "Community Value",
      description: "Building tools for a community you belong to creates alignment between user needs and product decisions. Authenticity drives better products."
    }
  ],
  nextSteps: [
    {
...
export const scentStackReflectionData: ReflectionProps = {
  ...
  content: "ScentStack represents a different kind of project—one born from genuine personal interest rather than market opportunity. As a fragrance collector, I'd spent years accumulating knowledge about dupes, layering, and the subjective language of scent. This platform became a way to systematize that knowledge and share it with others facing the same discoveries I'd made through trial and error.",
  insights: [
    {
      title: "Passion Projects Ship Faster",
      description: "When you're building for yourself, decisions come quickly. I didn't need user research to understand pain points—I'd lived them. The 3-week timeline was possible because domain expertise eliminated guesswork."
    },
    {
      title: "AI Democratizes Expertise",
      description: "GPT-4 and computer vision allowed me to encode fragrance knowledge that typically takes years to develop. AI features made ScentStack more than a database—it became a knowledgeable companion for fragrance discovery."
    },
    {
      title: "Personal Investment Drives Quality",
      description: "I'll use this platform myself for years. That knowledge shaped every decision—from data accuracy to mobile responsiveness. Building for yourself creates accountability that external deadlines can't match."
    }
  ]
};

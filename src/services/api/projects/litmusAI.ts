...
export const getLitmusAIProject = (): ProjectType => {
  return {
    ...
    description:
      "An adaptive AI-powered platform that measures and certifies AI literacy in under 5 minutes through personalized testing and learning pathways.",
    ...
    technicalHighlights: [
      "GPT-5 powered adaptive assessment logic with dynamic difficulty adjustment",
